...
- `CollectionSpace::Mapper::VocabularyTerms::Handler` now has a `delete_term` method, defaulting to performing a soft delete of the term. It can be called with `mode: :hard` to force a true delete of the term.

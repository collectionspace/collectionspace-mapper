...
- https://github.com/collectionspace/collectionspace-mapper/blob/main/doc/setup_for_development.adoc[Setting up for development/testing]
- https://github.com/collectionspace/collectionspace-mapper/blob/main/doc/usage.adoc[How to use `collectionspace-mapper` and its results]
- https://github.com/collectionspace/collectionspace-mapper/blob/main/doc/batch_configuration.adoc[Data processing and transformation options]

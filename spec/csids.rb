...
module Helpers
  def cacheable_csids
    [
      ...
      ['citationauthorities', 'citation', 'FNA Volume 19', '8376-2428-6810-2705'],
      ['citationauthorities', 'citation', 'Harding', '7652-1509-4094-4288'],
      ['citationauthorities', 'citation', 'Sp. Pl. 2: 899. 1753', '5588-9512-8452-1253'],
      ['citationauthorities', 'citation', 'Wanting', '3909-1472-3508-9314'],
      ['citationauthorities', 'citation', 'makasi', '3955-6978-3064-5015'],
      ['citationauthorities', 'worldcat', 'Bull. Torrey Bot. Club', '6643-2003-1765-6994'],
      ...
      ['locationauthorities', 'indeterminate', '~Indeterminate Location~', '6550-9457-8092-2010'],
      ...
      ['locationauthorities', 'offsite_sla', 'Lavington', '0075-7235-8017-4186'],
      ...
      ['orgauthorities', 'organization', 'Bonsai Museum', '1060-3655-0331-5347'],
      ...
      ['orgauthorities', 'organization', 'Organization 1', '6014-0563-7275-7116'],
      ...
      ['personauthorities', 'person', 'Debbie Depositor', '8157-7830-7082-8545'],
      ...
      ['personauthorities', 'person', 'Priscilla Plantsale', '6550-9637-3993-9656'],
      ...
      ['placeauthorities', 'place', 'York County, Pennsylvania', '3935-9866-9816-9139'],
      ...
      ['vocabularies', 'behrensmeyer', '0 - no cracking or flaking on bone surface', '3326-1750-5327-7581'],
      ['vocabularies', 'behrensmeyer', '1 - longitudinal and/or mosaic cracking present on surface', '7908-5047-1851-2936'],
      ['vocabularies', 'behrensmeyer', '2 - longitudinal cracks, exfoliation on surface', '9952-3369-8128-1850'],
      ['vocabularies', 'behrensmeyer', '3 - fibrous texture, extensive exfoliation', '2840-1757-4058-9690'],
      ['vocabularies', 'behrensmeyer', '4 - coarsely fibrous texture, splinters of bone loose on the surface, open cracks', '6978-3358-6091-1718'],
      ['vocabularies', 'behrensmeyer', '5 - bone crumbling in situ, large splinters', '2362-7188-5503-1720'],
      ...
      ['vocabularies', 'conditioncheckmethod', 'Observed', '4184-8280-2657-5675'],
      ['vocabularies', 'conditioncheckreason', 'Damaged in transit', '9713-8148-8367-8261'],
      ['vocabularies', 'conditionfitness', 'Reasonable', '8190-8625-6193-6555'],
      ['vocabularies', 'conservationstatus', 'Analysis complete', '2619-7339-9140-0556'],
      ['vocabularies', 'conservationstatus', 'Treatment approved', '6945-4964-1400-3230'],
      ['vocabularies', 'conservationstatus', 'Treatment in progress', '8385-9204-3223-8445'],
      ['vocabularies', 'cranialdeformationcategory', 'circumferential', '6933-9280-3767-6840'],
      ['vocabularies', 'cranialdeformationcategory', 'other (describe)', '1064-5392-9969-9019'],
      ['vocabularies', 'cranialdeformationcategory', 'tabular', '4273-6637-0660-9513'],
      ...
      ['vocabularies', 'deaccessionapprovalgroup', 'board of trustees', '4243-5019-2787-9404'],
      ['vocabularies', 'deaccessionapprovalgroup', 'collection committee', '9067-5042-5399-6404'],
      ['vocabularies', 'deaccessionapprovalgroup', 'executive committee', '4687-3956-7102-2911'],
      ['vocabularies', 'deaccessionapprovalstatus', 'approved', '4521-6403-5701-5339'],
      ['vocabularies', 'deaccessionapprovalstatus', 'not approved', '5921-3084-9315-9933'],
      ['vocabularies', 'deaccessionapprovalstatus', 'not required', '8677-7505-9102-9846'],
      ['vocabularies', 'dentitionscore', 'not applicable', '0965-4692-2661-1342'],
      ['vocabularies', 'disposalmethod', 'destruction', '4068-5873-0178-3181'],
      ['vocabularies', 'disposalmethod', 'public auction', '0785-1450-2258-4345'],
      ['vocabularies', 'durationunit', 'Days', '5991-3245-2930-0013'],
      ['vocabularies', 'durationunit', 'Hours', '4793-4778-7110-9430'],
      ['vocabularies', 'entrymethod', 'Found on doorstep', '6489-3737-4010-0870'],
      ['vocabularies', 'entrymethod', 'Post', '7699-7232-9429-2342'],
      ['vocabularies', 'examinationphase', 'before treatment', '1322-2127-2572-5670'],
      ['vocabularies', 'examinationphase', 'during treatment', '4315-1388-7255-7424'],
      ['vocabularies', 'exhibitionpersonrole', 'Educator', '4352-5778-5213-5852'],
      ['vocabularies', 'exhibitionpersonrole', 'Public programs coordinator', '2879-3691-6832-6621'],
      ['vocabularies', 'exhibitionreferencetype', 'News article', '7190-0752-1966-2113'],
      ['vocabularies', 'exhibitionreferencetype', 'Press release', '1935-8905-4261-7557'],
      ['vocabularies', 'exhibitionstatus', 'Preliminary object list created', '0280-1505-1286-4149'],
      ['vocabularies', 'exhibitiontype', 'Temporary', '3233-8223-5436-8996'],
      ['vocabularies', 'inventorystatus', 'accession status unclear', '6928-7239-7536-7312'],
      ...
      ['vocabularies', 'limitationlevel', 'recommendation', '1839-7476-1158-9123'],
      ...
      ['vocabularies', 'loanoutstatus', 'Photography requested', '9641-7705-5759-0740'],
      ['vocabularies', 'loanoutstatus', 'Refused', '4949-9589-4257-4022'],
      ['vocabularies', 'loanoutstatus', 'Returned', '2073-2572-6608-9033'],
      ['vocabularies', 'mortuarytreatment', 'burned/unburned bone mixture', '4602-4808-7974-1621'],
      ['vocabularies', 'mortuarytreatment', 'enbalmed', '8404-9161-1555-8147'],
      ['vocabularies', 'mortuarytreatment', 'excarnated', '6486-9602-4789-4873'],
      ['vocabularies', 'mortuarytreatment', 'mummified', '0284-1241-3660-0158'],
      ['vocabularies', 'nagpracategory', 'not subject to NAGPRA', '8208-4494-3072-9698'],
      ['vocabularies', 'nagpracategory', 'subject to NAGPRA (unspec.)', '4162-9179-6934-2367'],
      ['vocabularies', 'nagpraclaimtype', 'affiliated human skeletal remains (HSR)', '6232-9172-5961-6782'],
      ['vocabularies', 'nagpraclaimtype', 'needs further research', '3492-8911-9546-6579'],
      ['vocabularies', 'nagpraclaimtype', 'not subject to NAGPRA', '0274-6936-9265-5703'],
      ['vocabularies', 'nagpraclaimtype', 'object of cultural patrimony', '5698-4286-0776-5216'],
      ['vocabularies', 'nagpraclaimtype', 'unassociated funerary object (UFO)', '8752-0302-3578-2044'],
      ['vocabularies', 'newsarticle', 'News article', '0130-6106-8629-0645'],
      ['vocabularies', 'osteocompleteness', 'mandible only', '0749-7428-8960-0662'],
      ...
      ['vocabularies', 'prodpeoplerole', 'designed after', '5177-6183-6268-2668'],
      ['vocabularies', 'prodpeoplerole', 'traditional makers', '8816-7519-6448-7528'],
      ['vocabularies', 'propActivityType', 'benlate and captan', '6212-9584-7788-3632'],
      ['vocabularies', 'propChemicals', 'benlate and physan', '3184-2672-8367-8663'],
      ...
      ['vocabularies', 'publishto', 'CollectionSpace Public Browser', '6575-5990-2138-7970'],
      ...
      ['vocabularies', 'trepanationcertainty', 'clear evidence of trepanation', '5315-2607-6887-4691'],
      ['vocabularies', 'trepanationcertainty', 'possible trepanation', '1026-5179-4496-2355'],
      ['vocabularies', 'trepanationhealing', 'definite evidence for healing', '4469-2446-9879-8007'],
      ['vocabularies', 'trepanationhealing', 'no healing', '5527-5021-3694-5234'],
      ['vocabularies', 'trepanationhealing', 'possible healing', '8571-3105-6825-9302'],
      ['vocabularies', 'trepanationtechnique', 'grooving', '1667-7418-5259-2407'],
      ['vocabularies', 'uocauthorizationstatuses', 'Approved', '9749-1412-4351-7329'],
      ['vocabularies', 'uoccollectiontypes', 'archeology', '8415-1574-5268-5260'],

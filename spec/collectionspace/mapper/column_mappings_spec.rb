...
RSpec.describe CollectionSpace::Mapper::ColumnMappings,
  vcr: "core_domain_check" do
    ...
    # Building the handler calls RecordMapper, which calls the
    #   described class to set the handler.record settings, including
    #   :mappings. The :mappings setting is an instance of the
    #   described class, so we test the handler config

...
RSpec.describe CollectionSpace::Mapper::DataMapper, :integration do
  ...
  context 'bonsai profile' do    
    context 'objectexit record' do
      let(:mapper_path){ 'spec/fixtures/files/mappers/release_6_1/bonsai/bonsai_4-1-1_objectexit.json' }

      context 'record 1' do
        let(:datahash_path){ 'spec/fixtures/files/datahashes/bonsai/objectexit1.json' }

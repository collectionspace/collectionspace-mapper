...
RSpec.describe CollectionSpace::Mapper::DataMapper, :integration do
  ...
  context 'anthro profile' do
    context 'claim record' do
      ...
      let(:mapper_path){ 'spec/fixtures/files/mappers/release_6_1/anthro/anthro_4-1-2_claim.json' }

      context 'record 1' do
        let(:datahash_path){ 'spec/fixtures/files/datahashes/anthro/claim1.json' }
    ...
    context 'collectionobject record' do
      ...
      context 'record 2' do
        let(:datahash_path){ 'spec/fixtures/files/datahashes/anthro/collectionobject2.json' }
    ...
    context 'osteology record' do
      let(:mapper_path){ 'spec/fixtures/files/mappers/release_6_1/anthro/anthro_4-1-2_osteology.json' }

      context 'record 1' do
        let(:datahash_path){ 'spec/fixtures/files/datahashes/anthro/osteology1.json' }

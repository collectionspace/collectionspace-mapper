...
RSpec.describe CollectionSpace::Mapper::DataValidator do
  before(:all) do
    ...
    @anthro_dv = CollectionSpace::Mapper::DataValidator.new(CollectionSpace::Mapper::RecordMapper.new(mapper: @anthro_object_mapper, termcache: anthro_cache), anthro_cache)
    ...
    @botgarden_dv = CollectionSpace::Mapper::DataValidator.new(CollectionSpace::Mapper::RecordMapper.new(mapper: @botgarden_loanout_mapper, termcache: botgarden_cache), botgarden_cache)
    ...
    @core_authhier_dv = CollectionSpace::Mapper::DataValidator.new(CollectionSpace::Mapper::RecordMapper.new(mapper: @core_authhier_mapper, termcache: core_cache), core_cache)
  end
  ...
  describe '#validate' do
    ...
    context 'when recordtype has multiauthority required field' do
      before(:all) do
        ...
        @validator = CollectionSpace::Mapper::DataValidator.new(CollectionSpace::Mapper::RecordMapper.new(mapper: @mapper, termcache: core_cache), core_cache)
      end
      it 'validates' do

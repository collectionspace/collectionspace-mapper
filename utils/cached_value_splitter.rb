...
class CachedTerm
  ...
  def replace_domain
    refname.dup.sub(/^urn:cspace:[a-z]+\.collectionspace\.org/, 'urn:cspace:DOMAIN')
  end
...
terms = [
  ...
  ['personauthorities', 'person', 'John Doe', {refname: "urn:cspace:core.collectionspace.org:personauthorities:name(person):item:name(JohnDoe1416422840)'John Doe'", csid: '123'}],
